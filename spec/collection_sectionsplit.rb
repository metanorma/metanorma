...
RSpec.describe Metanorma::Collection do
  ...
  it "YAML collection with multiple documents sectionsplit (source document for links)" do
    ...
    expect(rice).to include %(It is not applicable to cooked rice products, which are not discussed in <a href="rice-en.final.xml.2.html#anotherclause_ISO_17301-1:2016_ISO_17301-1:2016_2_This_is_another_clause"><span class="citesec">Clause 2</span></a> or <a href="rice-en.final.xml.3.html#thirdclause_ISO_17301-1:2016_ISO_17301-1:2016_3_This_is_another_clause"><span class="citesec">Clause 3</span></a>.</p>)
    expect(rice).to include %(<div id=\"_scope_ISO_17301-1:2016_ISO_17301-1:2016_1_Scope\">)
    ...
    expect(p.to_xml.gsub(/ (source|id|semx-id)="[^"]+"/, "")).to be_equivalent_to <<~OUTPUT
      <p>This document is updated in <eref type="inline" bibitemid="RiceAmd_ISO_17301-1:2016_ISO_17301-1:2016_1_Scope" citeas="ISO 17301-1:2016/Amd.1:2017"/><semx element="eref"><fmt-link target="rice-amd.final.html"><span class="stdpublisher">ISO </span><span class="stddocNumber">17301</span>-<span class="stddocPartNumber">1</span>:<span class="stdyear">2016</span>/Amd.1:2017</fmt-link></semx>.</p>
    OUTPUT
    FileUtils.rm_rf of
  end
  ...
  it "YAML collection with multiple documents sectionsplit (target document for links)" do
    ...
    expect(File.read("#{OUTPATH}/rice-en.final.html"))
      .to include %(It is not applicable to cooked rice products, which are not discussed in <a href="#anotherclause_ISO_17301-1:2016"><span class="citesec">Clause 2</span></a> or <a href="#thirdclause_ISO_17301-1:2016"><span class="citesec">Clause 3</span></a>.</p>)
    # demonstrate that erefs are removed if they point to another document in the repository,
    # and point to the right sectionsplit file
    expect(File.read("#{OUTPATH}/rice-en.final.html"))
      .to include %(This document is also unrelated to <a href="dummy.xml.3.html#what">)
    expect(File.read("#{OUTPATH}/rice-en.final.html"))
      .to include %{This document is also unrelated to <a href="dummy.xml.3.html#what">current-metanorma-collection/ISO 17302:2016 3 What?</a>.</p><p id="_001_ISO_17301-1:2016">This document uses schemas E0/A0, <a href="dummy.xml.2.html#A1_ISO_17302:2016_ISO_17302:2016_2">E1/A1</a> and <a href="dummy.xml.4.html#E2_ISO_17302:2016_ISO_17302:2016_4">E2</a>.</p>}
    FileUtils.rm_rf of
  end
  ...
  it "deals with footnotes and review in section split" do
    ...
    output = <<~OUTPUT
      <xml>
          <a class="FootnoteRef" href="#fn:_97_ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1" id="fnref:1">
             <sup>1</sup>
          </a>
          <a class="FootnoteRef" href="#fn:_98_ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1" id="fnref:2">
             <sup>2</sup>
          </a>
          <aside id="fn:_97_ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1" class="footnote">
             <p id="__ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1">
                <a class="FootnoteRef" href="#fn:_97_ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1">
                   <sup>1</sup>
                </a>
                First footnote
             </p>
          ...
          <aside id="fn:_98_ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1" class="footnote">
             <p id="__ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1">
                <a class="FootnoteRef" href="#fn:_98_ISO_17301-1:2016_ISO_17301-1:2016_1_Clause_1">
                   <sup>2</sup>
                </a>
                Second footnote
             </p>
    ...
    output = <<~OUTPUT
          <xml>
         <a class="FootnoteRef" href="#fn:_83_ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2" id="fnref:1">
            <sup>1</sup>
         </a>
         <a class="FootnoteRef" href="#fn:_84_ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2" id="fnref:2">
            <sup>2</sup>
         </a>
         <aside id="fn:_83_ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2" class="footnote">
            <p id="__ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2">
               <a class="FootnoteRef" href="#fn:_83_ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2">
                  <sup>1</sup>
               </a>
               Third footnote
            </p>
         ...
         <aside id="fn:_84_ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2" class="footnote">
            <p id="__ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2">
               <a class="FootnoteRef" href="#fn:_84_ISO_17301-1:2016_ISO_17301-1:2016_2_Clause_2">
                  <sup>2</sup>
               </a>
               Fourth footnote
            </p>
    ...
    output = <<~OUTPUT
      <xml>
         <a class="FootnoteRef" href="#fn:_85_ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3" id="fnref:1">
            <sup>1</sup>
         </a>
         <a class="FootnoteRef" href="#fn:_86_ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3" id="fnref:2">
            <sup>2</sup>
         </a>
         <aside id="fn:_85_ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3" class="footnote">
            <p id="__ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3">
               <a class="FootnoteRef" href="#fn:_85_ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3">
                  <sup>1</sup>
               </a>
               Fifth footnote
            </p>
         ...
         <aside id="fn:_86_ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3" class="footnote">
            <p id="__ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3">
               <a class="FootnoteRef" href="#fn:_86_ISO_17301-1:2016_ISO_17301-1:2016_3_Clause_3">
                  <sup>2</sup>
               </a>
               Sixth footnote
            </p>
