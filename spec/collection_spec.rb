...
RSpec.describe Metanorma::Collection do
  ...
  context "render html & build doc, pdf, xml files from" do
    it "YAML collection" do # rubocop:disable metrics/blocklength
      ...
      expect(xmlpp(concat_file).sub(%r{xlink:href='data:image/gif;base64,[^']*'}, "xlink:href='data:image/gif;base64,_'")).to be_equivalent_to xmlpp(concat_text).sub(%r{src='xlink:href='data:image/gif;base64[^']*'}, "xlink:href='data:image/gif;base64,_'")
